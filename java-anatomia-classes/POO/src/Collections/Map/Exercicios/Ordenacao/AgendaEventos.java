package Collections.Map.Exercicios.Ordenacao;
...
public class AgendaEventos {
    ...
    public void obterProximoEvento() {
     ...
     //for (var entry : eventosMap.entrySet())  o var não obriga colocar a declarar o tipo da variável

      for (Map.Entry<LocalDate, Evento> entry : eventosMap.entrySet()) {// ele retorna um set com objetos do tipo map.entry contendo uma ligação com esses elementos
        LocalDate dataEvento = entry.getKey();
